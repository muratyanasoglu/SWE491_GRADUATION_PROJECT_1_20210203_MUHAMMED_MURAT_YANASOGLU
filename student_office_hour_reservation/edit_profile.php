...
if (isset($_POST['remove_picture'])) {
    ...
    if ($profile_picture) {
        ...
        $connection->query("UPDATE students SET profile_picture = NULL WHERE id = '$student_id'");
...
if (isset($_POST['update'])) {
    ...
    if (!empty($password) && $password != $confirm_password) {
        ...
        $update_query = "UPDATE students SET full_name = '$full_name', student_number = '$student_number', email = '$email', whatsapp_number = '$whatsapp_number', password = '$hashed_password', profile_picture = '$profile_picture' WHERE id = '$student_id'";
        if ($connection->query($update_query) === TRUE) {
            $success = "Profile updated successfully!";
            header("Location: profile.php");
            exit;
        } else {
            $error = "An error occurred while updating profile: " . $connection->error;
        }
    }
}
?>
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="student_number" name="student_number" value="<?php echo $user['student_number']; ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="whatsapp_number" name="whatsapp_number" value="<?php echo $user['whatsapp_number']; ?>" required>
            </div>
